...
async function updateTomSubscription() {
  try {
    ...
    // Get the Instagram Growth package (assuming that's what they subscribed to)
    ...
    user.subscription = {
      ...
      status: 'active',
      stripeSubscriptionId: 'sub_manual_update_' + Date.now(),
    ...
    await user.save();
    console.log('✅ Tom\'s subscription updated manually');
